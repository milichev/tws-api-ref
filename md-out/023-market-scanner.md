...
**subscription:** [ScannerSubscription](/campus/ibkr-api-page/twsapi-ref/#scannersubscription-ref). Object containing details on what values should be used to construct and sort the list.
