...
\*RDD: These tick types are provided only when the user makes a request to [EClient.reqMarketDataType(3)](20-delayed-market-data.md) prior to their market data request.
