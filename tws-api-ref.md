...
![TWS Global Configuration window displaying General Settings and the Memory Allocation section.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/06/擷取2-700x439.png)
...
![TWS Global Configuration window displaying Lock and Exit Settings.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
Login failed = Soft token=0 received instead of expected permanent
            for zdc1.ibllc.com:4001 (SSL)
```
,  this means you need to manually login again to complete the weekly reauthentication task.
...
![TWS Global Configuration window displaying API Precautions.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/06/擷取4-700x445.png)
...
![TWS Connections Window.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/06/擷取5.png)
...
2.  Which IB server location would you like to connect to?  -   TWS AMERICA – EAST (New York)
      3.   TWS AMERICA – CENTRAL (Chicago)
      4.   TWS Europe (Zurich)
      5.   TWS Asia (Hong Kong)
      6.   TWS Asia – CHINA (For mainland China users, if the account server is hosted in Hong Kong, they will automatically connect with the Shenzhen Gateway mcgw1.ibllc.com.cn)
    
3.  Which IB scheduled maintenance time do you choose? (Recommended to choose the default schedule maintenance time of its own IB server location)  -   North America
      9.   Europe
      10.   Asia
...
2.  The pre-decided IB server location connected from TWS is different from the IB Server location connected from IB Client Portal and IBKR Mobile.  -   IB server location connected from TWS is pre-decided. You can submit a web ticket to request the IB server relocation for the TWS connection.
      3.   IB server location connected from Client Portal or IBKR Mobile is based on your nearest IB server location. You cannot request the IB server relocation for Client Portal and IBKR Mobile connections. OAuth CP API users now cannot specify which server they want to connect to by themselves.
...
![TWS Global Configuration window displaying Smart Routing.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/06/擷取-1-700x440.png)
...
![TWS Global Configuration window displaying Presets for Advisors.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
4.  ![Highlights the TWS API versions for Windows.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
7.  Navigate to the directory where the installer has been downloaded (normally it should be your C: drive or D: drive) and confirm the file is present. Now, let’s take an example: install TWS API Python
    ...
     12.*$**  _**cd ~/TWS API/source/pythonclient**_  
     13.*$**  _**python3 setup.py install**_
...
3.  Once you have clicked “_**I Agree**_**“**, refer to the _Mac / Unix_ section to download the API Software version of your preference  
    ![Highlights the TWS API versions for Mac/Unix.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)
...
7.  Unzip the contents the installer into your home folder with the following command _(if prompted, enter your password):  
    ...
    9.*$  _sudo unzip twsapi\_macunix.n.m.zip -d $HOME/  
    ![Highlights the zip file name in command prompt.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)  
    
    ![](https://ibkr.info/system/files/image/IBKB2484/ibkb2484_install1b.png)_**
...
7.  Run the following command in MacOS Terminal.  -   **$ unzip** **twsapi\_macunix.<Major Version>.<Minor Version>.zip**
...
Noted in further depth through our [Architecture](http://localhost:3000/ibkr-api-page/twsapi-doc/#architecture) section, the TWS API is built using standardized socket protocol. As a result, users may develop or access alternative third party modules and classes in place of Interactive Brokers default modules through the [TWS API Download](http://localhost:3000/ibkr-api-page/twsapi-doc/#find-the-api). While the API is adaptable for client implementations, please understand that **Interactive Brokers API Support cannot provide support for non-standard implementations.** While we can review your [API logs](http://localhost:3000/ibkr-api-page/twsapi-doc/#api-logs) to affirm what content is being submitted, any further assistance will need to take place with the module’s original developer.
...
While Interactive Brokers’ API Support is aware of the ib\_insync package, we [cannot provide coding assistance](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#troubleshooting) for the package.
...
2.  Additional detail in the “Description” window for an instrument, normally available by right-clicking on an instrument in a watchlist and selecting Financial Instrument Info >> Description from the context menu. Debug=1 will add the conId, min order sizes, market rules (i.e., min price increments and thresholds), all available order types, and all available exchanges to this interface. Changing the behavior of TWS to bring up that Description window on double-click can make it easier to find.  1.  In TWS, go to Global Configuration >> Display >> Ticker Row
...
2.  In the “reason” text field, please type the reason for your upload.  -   Alternatively, type “ATTENTION: ” and then the ticket number you are working with, or the name of your customer service representative.
...
An example of a request is a query to retrieve [live watchlist data](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#watchlist-data). While you may make a single request for market data, you will receive market data until the subscription is cancelled or your session is disconnected. Only the original request to begin the flow of data will contribute to the pacing limitation.

The maximum number of API requests that can be submitted are equivalent to your [Maximum Market Data Lines](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#costs-and-fees) divided by 2, per second.
...
Clients that have increased their market data lines to 200, by way of commission or [Quote Booster Subscription](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#quote-max), would receive (200/2)= 100 requests per second, and this would increment as your market data lines increase or decrease.
...
![TWS Global Configuration API Settings showing Trusted IPs section.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/06/擷取2-1.png)
...
The content shown here is an example of what the Sync Wrapper structure looks like. A larger example of all current functionality is available in the 10.40 release of the TWS API under 
```
...
Users should connect with a client\_id of 0 for [optimal order management functionality](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#master-client-id).
...
The get\_account\_summary() function returns all relevant account details identical to Trader Workstation’s “Account” window. Users may query to receive all available data or a narrow window based on the [Account Summary Tag](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#account-summary-tags).

#### get\_account\_summary(

**tags:** String. Account summary key value to receive data for. See [Account Summary Tags](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#account-summary-tags) for details.
...
Interactive Brokers trading is centered around [Contract Objects](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object). This is used when submitting requests for market data, retrieving position information, and placing orders. The Synchronous Wrapper utilizes the same [Contract Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object) as the standard TWS API.
...
**contract:** [Contract Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object). Contract details you are searching for.
...
The get\_contract\_details() function will return a list of [Contract](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object) objects.  
...
The request currently supports [tickPrice, tickSize, tickString, tickGeneric, tickNews, and tickOptionCompution](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#receive-live-data) data.

#### get\_market\_data\_snapshot(

**contract:** [Contract Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object). Contract to retrieve market data for.

**generic\_tick\_list:** String. String containing comma-separate values to determine addition data to retrieve.

Default: Automatically sends an empty string, returning only the basic data such as Last, Bid, and Ask. See [Available Tick Types](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#available-tick-types) for more details.
...
**duration\_str:** String. The total timespan the bars should cover. See [Duration](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#hist-duration) for details.

**bar\_size\_setting:** String. The time span covered by each bar. See [Bar Sizes](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#hist-bar-size) for details.

**what\_to\_show:** String. Determines what kind of data should be returned. See [whatToShow](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#historical-whattoshow) for more details.
...
Requesting historical bars will return return a list containing all [Bar](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#bar-ref) objects for the duration. Please be aware that directly printing this information may result in the memory address being displayed.

### Place Order

#### place\_order\_sync(

**contract:** [Contract Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object). Contract to trade.

**order:** [Order Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#order-object). Order parameters to be traded.
...
Upon placing an order, a dictionary containing all of the order status’s information will be returned. As the response is static, refer to the [get\_open\_orders](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#sync-open-orders) function more more details on the current order status.

#### Response Object

{  
orderId: Integer. The identifier for the order. Relevant for order tracking, modification, and cancellation.  
status: String. The current status of the order. See [Order Status](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#order-status-message) for more details.  
...
parentId: Integer. The orderId for the parent of this contract. Will return 0 unless trading a [bracket or](http://localhost:3000/campus/ibkr-api-page/order-types/#bracket-orders) [OCA](http://localhost:3000/campus/ibkr-api-page/order-types/#one-cancels-all-orders) order.  
lastFillPrice: Float. The price of the most recent execution for the order.  
clientId: Integer. The identifier for which client ID the order was placed through. Orders can only be cancelled or modified by their on the [clientId they are bound to](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#modify-order).  
...
**order\_id:** Integer. Identifier for the order to cancel. Retrieved from the original [Order Placement](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#sync-place-order) or [get\_open\_orders()](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#sync-open-orders).

**order:** [OrderCancel Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#ordercancel-ref). Order cancellation parameters.

**timeout:** Integer. A default value of 3 seconds is supplied.

#### )

Upon cancellingan order, a dictionary containing all of the order status’s information will be returned. As the response is static, refer to the [get\_open\_orders](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#sync-open-orders) function more more details on the current order status.
...
**parentId:** Integer. The orderId for the parent of this contract. Will return 0 unless trading a [bracket](http://localhost:3000/campus/ibkr-api-page/order-types/#bracket-orders) or [OCA](http://localhost:3000/campus/ibkr-api-page/order-types/#one-cancels-all-orders) order.

**lastFillPrice:** Float. The price of the most recent execution for the order.

**clientId:** Integer. The identifier for which client ID the order was placed through. Orders can only be cancelled or modified by their on the [clientId](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#modify-order) they are bound to.
...
{  
{Order ID}: Dictionary. Returns the [Contract](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object), [Order](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#order-object), and [OrderState](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#orderstate-ref) objects of the affiliated orderId.  
{  
orderId: Integer. The identifier for the order. Relevant for order tracking, modification, and cancellation.

**contract:** [Contract Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#contract-object). Contract to trade.

**order:** [Order Object](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#order-object). Parameters for the given order to execute.

**orderState:** [OrderState Object](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#orderstate-ref). Current state of the order. Contains margin impact and status details.
...
**exec\_filter:** [ExecutionFilter Object](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#execfilter-ref). Parameters to restrict the Execution data to be returned.
...
**execution:** [Execution Object](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#exec-ref). Execution details regarding the recent trade.
...
-   An **underlier**, which may or may not be artificial:  -   For **CME products**, a tradable Event Contract will have the relevant CME future as its underlier. Therefore, the security type of the CME contract will be a futures option, or “FOP”.
...
-   An **Exchange** value will reflect the listing exchange of the given Event contract.  -   ForecastEx contracts will always use “FORECASTX” as the exchange value. Note the value does not include the final “E” in “ForecastEx”.
...
-   A **Trading Class** which also reflects the issuer’s product code for the instrument, and in the case of CME Group products, is used to differentiate Event Contracts from CME futures options.  -   Note that many CME Group Event Contracts, which resolve against CME Group futures, are assigned a Trading Class prefixed with “EC” and followed by the symbol of the relevant futures product, to avoid naming collisions with other derivatives (i.e., proper futures options listed on the same future).
    
-   A **Put or Call (Right)** value, where Call = Yes and Put = No.  -   Note that ForecastEx instruments do not permit Sell orders. Instead, ForecastEx positions are flattened or reduced by buying the opposing contract. CME Group Event Contracts permit both buying and selling.
    
-   An artificial **Contract Month** value, again used primarily for searching and filtering available instruments. Most Event Contract products do not follow monthly series as is common with index or equity options, so these Contract Month values are typically not a meaningful attribute of the instrument. Rather, they permit filtering of instruments by calendar month.  -   Requesting Contract Details for a given instrument will return a “realExpirationDate”, which will correspond with the same values printed in the ForecastTrader page.
...
-   An **instrument description (or “local symbol”)** in the form 
    ...
    , where:  -   ```
          PRODUCT
          ```
           is the issuer’s product identifier
      -   ```
          EXPIRATION
          ```
           is the date of the instrument’s resolution in the form 
          ```
          MmmDD'YY
          ```
          , e.g., “Sep26’24”
      -   ```
          STRIKE
          ```
           is the numerical value that determines the contract’s moneyness at expiration
      -   ```
          RIGHT
          ```
           is a value YES or NO
...
Part of requested market data requires additional subscription for API
 ...
 | 10089                                                                                               |                                                                                                                                                                                                                                                                                   | The market data subscribed with the user does not extend support for API use. See [TWS vs API Data](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#tws-vs-api) for more details.                                                                                                                                                                                                                                  |
 ...
 | 10091                                                                                               |                                                                                                                                                                                                                                                                                   | The market data subscribed with the user does not extend support for API use. See [TWS vs API Data](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#tws-vs-api) for more details.                                                                                                                                                                                                                                  |
...
Error 10089 notes that clients are requesting market data when they do not maintain a valid market data subscription. To resolve this issue, users must add a market data subscription to [the specific user they are requesting market data with](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#md-users). Alternatively, users must [request delayed market data](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#delayed-market-data) prior to requesting market data.

Market data availability is different in [TWS versus the API](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#tws-vs-api). As a result, market data you can receive in Trader Workstation may not be available in the API.

Interactive Brokers lists many of our most popular market data subscriptions [here](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#popular-md-subscriptions).
...
See our FAQ for more insight, [here](http://localhost:3000/lib/cstools/faq/#/content/102546341).
...
For all data, besides [Delayed Watchlist Data](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#delayed-market-data), a paid data subscription is required to receive market data through the API. See the [Market Data Subscriptions](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/) page for more information.
...
-   Some [Available Tick Types](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#available-tick-types) may not be provided due to the contract details, the time that you run the code…… ,etc. To verify whether the specific Available Tick Type is provided, it is suggested to manually check the data in TWS.
-   Different [Available Tick Types](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#available-tick-types) have different updating frequency.
...
Market depth data, also known as level II, represents an instrument’s order book. Via the TWS API it is possible to obtain this information with the [EClient.reqMarketDepth](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#request-market-depth) function.

Unlike [Top Market Data (Level I)](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#watchlist-data), market depth data is sent without sampling or filtering, however we cannot guarantee that every price quoted for a particular security will be displayed. In particular, odd lot orders are not included.

It is possible to Smart-route a [EClient.reqMarketDepth](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#request-market-depth) request to receive aggregated data from all available exchanges.

An integral part of processing the incoming data is monitoring [EWrapper.error](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#error) for message 317 “Market depth data has been RESET. Please empty deep book contents before applying any new entries.” and handling it appropriately, otherwise the update process would be corrupted.
...
Most indicators made available within the Trader Workstation are unavailable in the API. For more information on data not being available in via API, see [here](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#tws-vs-api).
...
The Advanced-Decline index must be requested with [EClient.reqMktData()](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#watchlist-data) where:
...
The Volume index must be requested with [EClient.reqMktData()](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#watchlist-data) where:
...
The Trade index must be requested with [EClient.reqMktData()](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#watchlist-data) where:
...
The TICK index must be requested with [EClient.reqMktData()](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#watchlist-data) where:
...
Users that do not have a valid [Market Data Subscription](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#popular-md-subscriptions) for the underlying contract will receive an error that Market Data Is Not Subscribed. This error can be ignored if Greeks are not wanted.  
 
...
See [here](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#reg-snapshot) for more information about Regulatory Snapshots and Market Data.
...
\*RDD: These tick types are provided only when the user makes a request to [EClient.reqMarketDataType(3)](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#delayed-market-data) prior to their market data request.
...
For detailed information about shortability data (shortable shares, fee rate) available outside of TWS, see [Short Securities Availability](http://localhost:3000/en/trading/short-securities-availability.php)
...
The maximum number of simultaneous tick-by-tick subscriptions allowed for a user is 5% of the user’s total market data lines. See [Specialized Market Data Lines](http://localhost:3000/campus/ibkr-api-page/market-data-subscriptions/#market-data-lines) for more information.
...
-   Time & Sales data requires a Level 1, Top Of Book market data subscription. This would be the same subscription as [EClient.reqMktData()](http://localhost:3000/campus/ibkr-api-page/trader-workstation-api/#watchlist-data) or [EClient.reqHistoricalData()](http://localhost:3000/campus/ibkr-api-page/trader-workstation-api/#historical-bars).
...
```
<ScanParameterResponse> <InstrumentList>
          <Instrument> <type>
```
**Location Code:** 
...
<ScanParameterResponse> <LocationTree> <Location>
          <LocationTree> <Location> <locationCode>
```
**Scan Code:**
...
```
<ScanParameterResponse> <FilterList> <RangeFilter>
          <AbstractField> <code>
```
...
**subscription:** [ScannerSubscription](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#scannersubscription-ref). Object containing details on what values should be used to construct and sort the list.
...
**commissionAndFeesReport:** [CommissionAndFeesReport](http://localhost:3000/ibkr-api-page/twsapi-ref/#commreport-ref). Returns a commissions report object containing the fields execId, commission, currency, realizedPnl, yield, and yieldRedemptionDate.  
)
...
**filter:** [ExecutionFilter](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#execfilter-ref). The filter criteria used to determine which execution reports are returned.  
)
...
As long as an order is active, it is possible to retrieve it using the TWS API. Orders submitted via the TWS API will always be bound to the client application (i.e. client Id) they were submitted from meaning only the submitting client will be able to modify the placed order. Three different methods are provided to allow for maximum flexibility. Active orders will be returned via the [IBApi.EWrapper.openOrder](http://localhost:3000/campus/ibkr-api-page/twsapi-api/#open-orders) and [IBApi.EWrapper.orderStatus](http://localhost:3000/campus/ibkr-api-page/twsapi-api/#order-status) methods as already described in [The openOrder callback](http://localhost:3000/campus/ibkr-api-page/trader-workstation-api/#open-orders) and [The orderStatus callback](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#order-status) sections
...
Because binding the order will change the order ID, this function will be rejected when used with the API Read-Only Mode enabled. You can find the steps for disabling read-only mode at in [TWS Settings](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#tws-config-api).
...
**orderCancel:** orderCancel. An OrderCancel object that can receive the manualOrderCancelTime, manualOrderIndicator, and extOperator fields. See [OrderCancel Reference](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#ordercancel-ref) for more insight on the OrderCancel class.  
)
...
1.  This field does not need to be reported if you are:  -   Using the TWS API to transmit orders, AND
      2.   The investment decision is always made by the client, AND
      3.   None of these clients are an EEA investment firm with delegated reporting selected (the “delegated reporting firm”).
...
-   Manually construct each child of the parent. See [Bracket Orders](http://localhost:3000/campus/ibkr-api-page/order-types/#bracket-orders) for more details.
...
Consider using [EWrapper.NextValidId](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#next-valid-id)

**PtOrderType** must always be set to “PRESET”.  
Be sure to review your [Presets in Trader Workstation](http://localhost:3000/en/?f=%2Fen%2Ftrading%2Ftws-order-presets.php) prior to submitting orders as the Profit taker details will mirror these details as set.
...
Be sure to review your [Presets in Trader Workstation](http://localhost:3000/en/?f=%2Fen%2Ftrading%2Ftws-order-presets.php) prior to submitting orders as the Stop loss details will mirror these details as set.

### Combo Orders

A user may create an order for a combination of symbols, referred to as a Spread or Combo, by the use of a [Spread Contract](http://localhost:3000/campus/ibkr-api-page/contracts/#twsapi-spreads).
...
Combination orders may be priced per-leg with no more than 2 legs in a [NonGuaranteed](http://localhost:3000/lib/cstools/faq/#/content/1163249841) order. This is accomplished with the [OrderComboLeg](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#ordercomboleg-ref) class and defining a price in each object. The [OrderComboLeg](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#ordercomboleg-ref) should then be added to the [Order object’s](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#order-ref) [OrderComboLegs](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#ordercomboleg-ref) attribute in an array.

#### Price Overall Order

To price an overall order, users would only need to define the lmtPrice or auxPrice values within the [Order object](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#order-ref) as they would if trading an individual contract.

### Trading The Overnight Session

In the event a user would like to designate a trade to take place during the Overnight trading hours, the [Order object](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#order-ref) must set “includeOvernight” set to True and optionally set the Exchange value to OVERNIGHT.

#### Routing exclusively to the Overnight market

Users that would like to route orders to [Overnight](http://localhost:3000/en/trading/ordertypes.php?m=overnightTradingModal) without trading during the regular session must set the [Order Object’s](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#order-ref) includeOvernight value as True and designate the exchange value as “OVERNIGHT”.

#### Routing as Overnight+DAY

Users that would like to route orders to [Overnight+DAY](http://localhost:3000/en/trading/ordertypes.php?m=overnightSmartModal) to trade during the day and the overnight session must set the [Order Object’s](http://localhost:3000/campus/ibkr-api-page/twsapi-ref/#order-ref) includeOvernight value as True and designate the exchange value as “SMART”.
...
-   If an order is subject to a large size (LGSZ) reject, the API client would receive **Error (201)** via **[IBApi::EWrapper::error](https://www.interactivebrokers.com/campus/ibkr-api-page/twsapi-doc/#error)**. The error text would indicate that order size too large and suggest another smaller size.  -   In accordance with our regulatory obligations as a broker, we cannot accept Large Limit Orders for #### shares of ABCD that you have submitted. Please submit a smaller order (not exceeding ###) _or convert your order to an algorithmic Order (IBALGO) \[conditional on instrument\]_
-   If an order is subject to price checks the client may receive status (cancelled) + **Error (202)** via [**IBApi.EWrapper.orderStatus**](https://www.interactivebrokers.com/campus/ibkr-api-page/twsapi-doc/#order-status) and **[IBApi::EWrapper::error](https://www.interactivebrokers.com/campus/ibkr-api-page/twsapi-doc/#error)**. The error text would indicate the price is too far from current price.  -   In accordance with our regulatory obligations as a broker, we cannot accept your order at the limit price ### you selected because it is too far through the market. Please submit your order using a limit price that is closer to the current market price ###
-   The client may receive warning Text via **[IBApi::EWrapper::openOrder](https://www.interactivebrokers.com/campus/ibkr-api-page/twsapi-doc/#open-orders)** indicating that the order could be subject to price capping.  -   If your order does not immediately execute, in accordance with our regulatory obligations as a broker we may, depending on market conditions, reject your order if the limit price of your order is more than allowed distance from the current reference price. This is designed to ensure that the price of your order is in line with an orderly market and reduce the impact your order has on the market. Please note that such rejection will result in you not receiving a fill.
...
-   See [here](http://localhost:3000/About%20Pre-Borrows) for Pre-Borrow Eligibility
...
![Initial margin change in the Order preview window.](data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMSIgaGVpZ2h0PSIxIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg==)

![](https://www.interactivebrokers.com/campus/wp-content/uploads/sites/2/2023/09/擷取-1-700x538.png)
...
While settings may be modified through this method, Read-Only access to the system must be first disabled manually through the GUI. See [TWS Settings](http://localhost:3000/campus/ibkr-api-page/twsapi-doc/#tws-config-api).

### Request Configuration

#### EClient.reqConfigProtoBuf(

**configRequestProto**: [ConfigRequestProto](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#config-response)  
...
**configResponseProto**: [ConfigResponseProto](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#config-response)  
Contains the Proto response object for the configuration. Includes [LockAndExitConfig](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#lock-and-exit), [MessageConfig](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#message-config), [ApiConfig](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#api-config), and [OrdersConfig](https://www.interactivebrokers.com/campus/ibkr-api-page/protobuf-reference/#orders-config).
...
**updateConfigRequestProto**: [UpdateConfigRequestProto](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#update-config-request)  
...
**updateConfigResponseProto**: [UpdateConfigResponseProto](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#update-config-response)  
Contains the Proto response object for the configuration update. Includes message, changedFields, errors, and [UpdateConfigWarning.](http://localhost:3000/campus/ibkr-api-page/protobuf-reference/#update-config-warning)
