...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>08.02.02 2. Navigate to Python Source</title>
    <style>
body {
...
.breadcrumb-item:last-child a:hover {
  ...
  <body>
      ...
      [08.02.02-setup-py-navigate.md](08.02.02 2. Navigate to Python Source) -> 
    
     08.02.02 2. Navigate to Python Source
