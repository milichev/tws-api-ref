...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>08.02.06 Protobuf UserWarning messages</title>
    <style>
body {
...
.breadcrumb-item:last-child a:hover {
  ...
  <body>
      ...
      [08.02.06-protobuf-warning.md](08.02.06 Protobuf UserWarning messages) -> 
    
     08.02.06 Protobuf UserWarning messages
